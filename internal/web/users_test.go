...
func TestCreateUser(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		req := CreateUserRequest{Username: "abc", Email: "a@b.com", Password: "123456", TeamID: 1, Role: "admin"}
	...
	t.Run("manager error", func(t *testing.T) {
		...
		req := CreateUserRequest{Username: "abc", Email: "a@b.com", Password: "123456", TeamID: 1, Role: "user"}
		rr := testRequest(t, createUser(m), http.MethodPost, "/users", req)
